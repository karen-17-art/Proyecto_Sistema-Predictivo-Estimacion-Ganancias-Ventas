...
st.title(
    "📊 Sistema Predictivo de Ganancia"
)
...
X_train_fe["ingreso_potencial"] = (

    X_train_fe["precio_promedio"]

    * X_train_fe["n_productos"]

)

X_test_fe["ingreso_potencial"] = (

    X_test_fe["precio_promedio"]

    * X_test_fe["n_productos"]
...
X_train_fe["perdida_descuento"] = (

    X_train_fe["precio_promedio"]

    * X_train_fe["desc_promedio"]

)

X_test_fe["perdida_descuento"] = (

    X_test_fe["precio_promedio"]

    * X_test_fe["desc_promedio"]
...
input_data["ingreso_potencial"] = (

    input_data["precio_promedio"]

    * input_data["n_productos"]

)

input_data["perdida_descuento"] = (

    input_data["precio_promedio"]

    * input_data["desc_promedio"]

)

input_data["rentabilidad_bruta"] = (
...
# =================================================
    ...
    if ganancia > promedio:
        ...
        st.success(
            ...
            f"🟢 Excelente. La ganancia estimada "
            f"de S/ {ganancia:,.2f} está por "
            f"encima del promedio histórico."
        ...
        st.warning(
            ...
            f"🟡 La ganancia estimada "
            f"de S/ {ganancia:,.2f} está por "
            f"debajo del promedio histórico."
